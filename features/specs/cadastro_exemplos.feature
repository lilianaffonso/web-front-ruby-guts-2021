...
| 'paula_ruby_0506213@guts.com' | 'masc' | 'Paula'    | 'Silva'   | '12345678' | '10' | 'March' | '1980' | 'no'       | 'Rua 3, lote 54' | 'São Leopoldo' | '59632' | 'California' | '5551566852242' | 'Casa'       |
| 'joao_ruby_0506213@guts.com'  | 'fem'  | 'João'     | 'Santos'  | '89101112' | '15' | 'April' | '1990' | 'yes'      | 'Rua 2, lote 52' | 'São Paulo'    | '56852' | 'Iowa'       | '5555668546242' | 'Trabalho'   |
